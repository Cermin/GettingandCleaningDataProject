...
VarNames<-read.table("/Users/Usha/Documents/UCI HAR Dataset/features.txt")

##  read the test data into a data frame and rename the columns per the values in VarNames
x_test<-read.table("/Users/Usha/Documents/UCI HAR Dataset/test/X_test.txt")
colnames(x_test)<-VarNames[,2] 

subject_test<-read.table("/Users/Usha/Documents/UCI HAR Dataset/test/subject_test.txt")
colnames(subject_test)<-"subject_ID"

y_test<-read.table("/Users/Usha/Documents/UCI HAR Dataset/test/y_test.txt")
colnames(y_test)<- "activity_name"

##  read the train data into a data frame and rename the columns per the values in VarNames

x_train<-read.table("/Users/Usha/Documents/UCI HAR Dataset/train/X_train.txt")
colnames(x_train)<-VarNames[,2]

subject_train<-read.table("/Users/Usha/Documents/UCI HAR Dataset/train/subject_train.txt")
colnames(subject_train)<- "subject_ID"

y_train<-read.table("/Users/Usha/Documents/UCI HAR Dataset/train/y_train.txt")
...
##  The variable names in features.txt was used in place of V1:V561 in step 1.
