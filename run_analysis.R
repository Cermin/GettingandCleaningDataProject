setwd("/Users/Usha/Documents/UCI HAR Dataset")
library(downloader)  ## used for downloading https files
library(utils)       ## needed for unzip function


########## Step 1: Download the zipped file and the unzip into a folder called Dataset #################################
...
##  Step 6:From the data set in step 4, create a second, independent tidy data set with
